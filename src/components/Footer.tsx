        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a href="https://www.facebook.com/people/OPUS-%E1%83%9D%E1%83%9E%E1%83%A3%E1%83%A1%E1%83%98/61579382222235/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-accent transition-colors">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://instagram.com/opus_edu/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-accent transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="mailto:contact@opusedu.ge" className="p-2 bg-white/10 rounded-full hover:bg-accent transition-colors">
